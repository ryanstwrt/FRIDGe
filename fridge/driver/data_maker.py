def make_mcnp_problem(assembly):
    ...
    kcode_output = 'kcode ' + str(assembly.material.num_particles_per_gen) + " 1.0 " + str(assembly.material.num_skipped_gens) + \
                   " " + str(assembly.material.num_gens) + '\n'
    ksrc_output = 'ksrc ' + str(assembly.material.ksrc[0]) + " " + str(assembly.material.ksrc[1]) + " " + str(assembly.material.ksrc[2]/3) + '\n'
